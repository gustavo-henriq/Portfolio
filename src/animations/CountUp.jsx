...
export function CountUp({value,suffix='',language='EN'}){
 ...
 return <span className="count-up" aria-label={final}><span className="count-reserve" aria-hidden="true">{final}</span><span className="count-value" ref={ref} aria-hidden="true">{final}</span></span>;
}
